function Profit() {
  return (
    <div className="w-screen h-full bg-gray-200">
      <div className="w-full max-w-[1200px] m-auto pt-[50px] p-8 px-4">
        ...
        <div className="grid md:grid-cols-3 sm:grid-cols-1 py-4 gap-4">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-4 gap-3">
              <div className="text-2xl ">20년수익</div>
              <div className="w-full bg-green-900 rounded-lg px-4 py-6 flex items-center justify-center text-3xl text-white">
                1,000,000,000원
              </div>
            </div>
        ...
        {/* <div className="grid md:grid-cols-3 sm:grid-cols-1 gap-x-[65px] gap-y-[25px] mt-4">
